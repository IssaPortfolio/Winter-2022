...
flipZombie = pygame.transform.flip(zombie_image, 90, 0)
...
class Player():
    ...
    def __init__(self):
        ...
        self.playerRect = player_image.get_rect(center = (self.x, self.y))
    ...
    def draw(self):
        ...
        if movementKeys[pygame.K_LEFT] or movementKeys[pygame.K_a]:
            flip = pygame.transform.flip(player_image, 90, 0)
...
class Zombies():
    ...
    def __init__(self):
        ...
        self.zombieRect = zombie_image.get_rect(center = (self.x, self.y))
...
def game():
    ...
    while True:
        ...
        if pygame.Rect.colliderect(player.playerRect, zombies.zombieRect) == True:
            print("player x: " + str(player.x))
            print("player y: " + str(player.y))
            print("zombie x: " + str(zombies.x))
            print("zombie x: " + str(zombies.y))
